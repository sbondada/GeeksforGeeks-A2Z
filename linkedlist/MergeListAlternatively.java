...
public class MergeListAlternatively
{
	...
	{
		MergeListAlternatively ml = new MergeListAlternatively();
		MergeListAlternatively.LinkedList list1= ml.new LinkedList(1);
		list1.addNode(2);
		list1.addNode(3);
		list1.addNode(4);
		list1.addNode(5);
		...
		list1.addNode(8);
		list1.printList();
		MergeListAlternatively.LinkedList list2= ml.new LinkedList(10);
		list2.addNode(11);
		list2.addNode(12);
		list2.addNode(13);
		list2.addNode(14);
